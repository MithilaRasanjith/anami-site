...
export default function SpecialGroupN5Client() {
  return (
    <div className="space-y-16 md:space-y-20">
          ...
          <div className="grid gap-10 md:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-4 text-base leading-relaxed text-text-muted">
                A small-group Japanese language class designed for beginners who want closer guidance,
                structured lessons, and consistent exam-focused progress.
              </p>
            ...
            <div className="rounded-3xl border border-border-light bg-bg-soft p-6">
              ...
              <dl className="mt-4 space-y-4 text-sm">
                {[
                  ...
                  { k: "Schedule", v: "Every Saturday & Sunday • 09.00 – 17.00" },
      ...
      <Reveal>
        <section className="rounded-3xl border border-border-light bg-bg-soft p-8 md:p-10">
          <h2 className="text-2xl font-semibold text-text-primary">Class format & approach</h2>
