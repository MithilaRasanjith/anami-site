...
export default function ALevelClient() {
  return (
          ...
          <div className="grid gap-10 md:grid-cols-2">
            ...
            <div>
              <span className="inline-flex rounded-full border border-border-light bg-bg-soft px-3 py-1 text-xs text-text-muted">
                Physical Group Class • G.C.E. A/L • Limited to 20 students
              </span>

              <h1 className="mt-4 text-4xl font-semibold tracking-tight text-text-primary md:text-5xl">
                Group Class – G.C.E. Advanced Level
              </h1>

              <p className="mt-4 text-base leading-relaxed text-text-muted">
                A structured Japanese group class for school candidates — built to support steady progress
                with consistent weekly learning and speaking practice.
              </p>

              <div className="mt-6 flex flex-col gap-3 sm:flex-row">
                <Link href="/register?course=alevel" className="btn-primary">
                  Register Now
                </Link>
                <Link
                  href="/contact"
            ...
            <div className="rounded-3xl border border-border-light bg-bg-soft p-6">
              ...
              <dl className="mt-4 space-y-4 text-sm">
                {[
                  ...
                  { k: "Schedule", v: "Every Sunday • 15.00 – 17.00" },
      ...
      <section className="grid gap-8 md:grid-cols-2">
        <Reveal>
          <div className="card p-8 transition hover:-translate-y-0.5 hover:shadow-md">
            ...
            <ul className="mt-6 space-y-3 text-sm text-text-primary">
              {[
                "Japanese foundations + gradual progression",
                "Vocabulary & comprehension practice",
                "Speaking practice for confidence",
                "Weekly revision and guided learning",
              ].map((item, i) => (
        ...
        <Reveal delayMs={120}>
          <div className="card p-8 transition hover:-translate-y-0.5 hover:shadow-md">
            ...
            <ul className="mt-6 space-y-3 text-sm text-text-primary">
              {[
                "School students preparing alongside A/L studies",
                "Learners who want physical classroom learning",
                "Students who prefer a guided group environment",
                "Beginners looking for steady weekly progress",
              ].map((item, i) => (
                <Reveal key={item} delayMs={i * 60}>
                  <li className="flex gap-2">
                    <span className="text-gold">•</span>
      ...
      <Reveal>
        <section className="rounded-3xl border border-border-light bg-bg-white p-8 shadow-md md:p-10">
          <div className="grid items-center gap-6 md:grid-cols-2">
            <div>
              <h2 className="text-2xl font-semibold text-text-primary">Ready to join the A/L class?</h2>
